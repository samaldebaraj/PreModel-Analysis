###****Designed by Debaraj Samal, 10-11-2022****###
import pandas as pd
import numpy as np
import io
import FeatureType
import WOE_IV
import TargetAnalysisCategorical
import TargetAnalysisContinuous
...
class EDA: 
	...
	def EDAToHTML(self,out=None):
		...
		if(out):
			...
			out_filename = os.path.join(this_dir, 'HTMLTemplate\\dist\\PreMod_Result.html')
